...
[Game Engine](../README.md) / ElementArgs

# Interface: ElementArgs

Defined in: [source/element.ts:9](https://github.com/noobiept/game_engine/blob/4a0e827671c0abfcc0c124a52b620c1ebc1fa665/source/element.ts#L9)

## Extends

- [`EventDispatcherArgs`](EventDispatcherArgs.md)

## Extended by

- [`ContainerArgs`](ContainerArgs.md)
- [`BitmapArgs`](BitmapArgs.md)
- [`CircleArgs`](CircleArgs.md)
- [`RectangleArgs`](RectangleArgs.md)
- [`TextArgs`](TextArgs.md)
...
[`EventDispatcherArgs`](EventDispatcherArgs.md).[`_eventDispatcherArgsBrand`](EventDispatcherArgs.md#_eventdispatcherargsbrand)
