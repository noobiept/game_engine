...
[Game Engine](../../../README.md) / Utilities

# Utilities

## Enumerations

- [DialogButtons](enumerations/DialogButtons.md)
- [DialogPosition](enumerations/DialogPosition.md)
...
- [Debounced](interfaces/Debounced.md)
...
- [Throttled](interfaces/Throttled.md)
...
- [DialogButtonsArg](type-aliases/DialogButtonsArg.md)
- [FileInfoType](type-aliases/FileInfoType.md)
- [InternationalizationConfig](type-aliases/InternationalizationConfig.md)
- [ManifestData](type-aliases/ManifestData.md)
- [PreloadData](type-aliases/PreloadData.md)
- [PreloadEvent](type-aliases/PreloadEvent.md)
- [SeededRandom](type-aliases/SeededRandom.md)
- [SeparatedTime](type-aliases/SeparatedTime.md)
- [UnitDescription](type-aliases/UnitDescription.md)
- [UpdateElement](type-aliases/UpdateElement.md)
- [UpdateFormat](type-aliases/UpdateFormat.md)

## Functions

- [boxBoxCollision](functions/boxBoxCollision.md)
- [calculateAngle](functions/calculateAngle.md)
- [calculateDistance](functions/calculateDistance.md)
- [capitalize](functions/capitalize.md)
- [circleCircleCollision](functions/circleCircleCollision.md)
- [circlePointCollision](functions/circlePointCollision.md)
...
- [getRandomFloat](functions/getRandomFloat.md)
- [getRandomInt](functions/getRandomInt.md)
- [getSeveralRandomInts](functions/getSeveralRandomInts.md)
...
- [numberOfDigits](functions/numberOfDigits.md)
- [pickN](functions/pickN.md)
- [pickOne](functions/pickOne.md)
- [pointBoxCollision](functions/pointBoxCollision.md)
